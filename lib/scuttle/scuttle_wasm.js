/* @ts-self-types="./scuttle_wasm.d.ts" */
...
export class Db {
    ...
    explain(sql) {
        ...
        try {
            ...
            const ret = wasm.db_explain(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    run(sql) {
        ...
        try {
            const ptr0 = passStringToWasm0(sql, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.db_run(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('scuttle_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
