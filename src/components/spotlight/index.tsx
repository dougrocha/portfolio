...
const SpotlightProject = () => {
  return (
    <section className="container flex flex-col justify-center px-6 mx-auto mt-40 max-w-7xl">
      <div>
        <p className="font-medium text-secondary-yellow">- Spotlight</p>
        <h2 className="text-5xl font-bold text-primary-white">Quanty</h2>
      </div>
      <div className="pr-3 mt-24 md:mt-32 lg:pl-20">
        <div className="flex flex-col items-start justify-center ">
          ...
          <p className="pl-4 text-xl text-primary-brightgray">
            This is the current project I am working on. Quanty is a Discord Bot
            with a dashboard. It&apos;s built with NextJs, NestJs, and
            Typescript. This project is mainly geared towards automating actions
            in discord while allowing users to have a fluid/easy experience with
            a dashboard.
          </p>
        </div>
        <div className="flex flex-col items-center justify-between mt-4 space-y-10 md:mt-2 md:flex-row md:space-y-0">
          ...
          <div className="flex items-center justify-between space-x-4 md:pr-8">
