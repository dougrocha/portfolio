...
Now we need to add our SSH public key to GitHub. You can do this by going to your GitHub profile settings and clicking on SSH and GPG keys. But you can also do it using the GitHub CLI:

> To learn more about the GitHub CLI, check out [GitHub CLI](https://docs.github.com/en/github-cli/github-cli/about-github-cli).

Before we use it though, we need to make sure we are logged in:

```bash
gh auth login
```

To add your key to your GitHub account, we are going to need to do a little bit of work. First lets get out SSH public key ready:
